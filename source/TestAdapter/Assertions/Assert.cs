    ...
    public sealed class Assert
    {
        ...
        public static void AreNotEqual(float notExpected, float actual, float delta, string message, params object[] parameters)
        {
            if (Math.Abs(notExpected - actual) <= delta)
            {
                var finalMessage = string.Format(
                    CultureInfo.CurrentCulture,
                    Resource.AreNotEqualDeltaFailMsg,
                    message == null ? string.Empty : ReplaceNulls(message),
        ...
        public static void IsNotInstanceOfType(object value, Type wrongType, string message, params object[] parameters)
        {
            ...
            if (expectedTypeInfo.IsAssignableFrom(elementTypeInfo))
            {
                string finalMessage = string.Format(
                    CultureInfo.CurrentCulture,
                    Resource.IsNotInstanceOfFailMsg,
                    message == null ? string.Empty : ReplaceNulls(message),
                    wrongType.ToString(),
                    value.GetType().ToString());
        ...
        public static void Inconclusive(string message, params object[] parameters)
        {
            ...
            throw new AssertInconclusiveException(string.Format(CultureInfo.CurrentCulture, Resource.AssertionFailed, "Assert.Inconclusive", finalMessage));
        }
        ...
        {
            Fail(Resource.DoNotUseAssertEquals);
            return false;
        }
        ...
        internal static void HandleFail(string assertionName, string message, params object[] parameters)
        {
            ...
            throw new AssertFailedException(string.Format(CultureInfo.CurrentCulture, Resource.AssertionFailed, assertionName, finalMessage));
        }
        ...
        internal static void CheckParameterNotNull(object param, string assertionName, string parameterName, string message, params object[] parameters)
        {
            if (param == null)
            {
                HandleFail(assertionName, string.Format(CultureInfo.CurrentCulture, Resource.NullParameterToAssert, parameterName, message), parameters);
            }
        }
        ...
        internal static string ReplaceNulls(object input)
        {
            ...
            if (input == null)
            {
                return Resource.Common_NullInMessages.ToString();
            }
            else
            {
                ...
                if (inputString == null)
                {
                    return Resource.Common_ObjectString.ToString();
                }
