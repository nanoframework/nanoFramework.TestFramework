...
//            {
//                var messageFormatOnException = string.Join("TestDiscoverer:DiaSession: Could not create diaSession for source:", source, ". Reason:{0}");
...
//            if (typeDiaSession != null && typeDiaNavigationData != null)
//            {
//                var messageFormatOnException = string.Join("TestDiscoverer:DiaSession: Could not get navigation data for class:", className, ". Reason:{0}");
