...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter
{
    ...
    internal class TestMethodFilter
    {
        ...
        internal ITestCaseFilterExpression GetFilterExpression(
            IDiscoveryContext context, 
            IMessageLogger logger, 
            out bool filterHasError
            )
        {
        ...
        internal TestProperty PropertyProvider(
            string propertyName
            )
        {
        ...
        internal object PropertyValueProvider(
