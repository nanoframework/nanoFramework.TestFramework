...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter
{
    ...
    public class TestSettings
    {
        ...
        /// </summary>
        private static TestSettings currentSettings;
        ...
        /// </summary>
        public static TestSettings CurrentSettings
        {
            get
            {
                if (currentSettings == null)
                {
                    currentSettings = new TestSettings();
                }
        ...
        public static void PopulateSettings(TestSettings settings)
        {
        ...
        internal static TestSettings GetSettings(string runsettingsXml, string settingName)
        {
        ...
        {
            TestSettings.CurrentSettings = null;
            TestSettings.RunConfigurationSettings = null;
        }
        ...
        /// <returns>An instance of the <see cref="TestSettings"/> class</returns>
        private static TestSettings ToSettings(XmlReader reader)
        {
        ...
        private static void SetParallelSettings(XmlReader reader, TestSettings settings)
        {
            reader.Read();
            if (!reader.IsEmptyElement)
            {
        ...
        private static void SetGlobalSettings(string runsettingsXml, TestSettings settings)
        {
