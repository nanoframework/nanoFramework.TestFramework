...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter.Utilities
{
    ...
    using nanoFramework.TestPlatform.MSTest.TestAdapter.Deployment;
    ...
    internal class DeploymentUtility
    {
        ...
        internal bool Deploy(
            ...
            ref TestRunDirectories testRunDirectories
            )
        {
        ...
        internal TestRunDirectories CreateDeploymentDirectories(
            IRunContext runContext
            )
        {
            ...
            )
        {
            ...
            {
                EqtTrace.Info("TestExecutor: Found that deployment items for source {0} are: ", source);

                foreach (var item in deploymentItems)
                {
                    EqtTrace.Info("TestExecutor: SourcePath: - {0}", item.SourcePath);
                }
            }
            ...
            EqtTrace.InfoIf(EqtTrace.IsInfoEnabled, "TestExecutor: Using deployment directory {0} for source {1}.", runDirectories.OutDirectory, source);
        ...
        private void Deploy(
            ...
            out IEnumerable<string> deploymentWarnings
            )
        {
        ...
        private void AddDependenciesOfDeploymentItem(
            string deploymentItemFile, 
            IList<string> filesToDeploy,
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Requirement is to handle all kinds of user exceptions and message appropriately.")]
        private string[] GetFullPathToFilesCorrespondingToDeploymentItem(
        ...
        private bool IsDeploymentItemSourceAFile(
            string deploymentItemSourcePath, 
            string testSource, 
            out string file
            )
        {
        ...
        private IEnumerable<DeploymentItem> GetSatellites(
        ...
        private string GetFullPathToDeploymentItemSource(
            string deploymentItemSourcePath, 
            string testSource
            )
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Requirement is to handle all kinds of user exceptions and message appropriately.")]
        private void ProcessNewStorage(
            string testSource, 
            IList<DeploymentItem> deploymentItems, 
            IList<string> warnings
            )
        ...
        private string GetRootDeploymentDirectory(
        ...
        private string AddTestSourceConfigFileIfExists(
            string testSource, 
            IList<DeploymentItem> deploymentItems
            )
        {
