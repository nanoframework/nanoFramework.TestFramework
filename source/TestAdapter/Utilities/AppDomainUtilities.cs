...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter.Utilities
{
    ...
    internal static class AppDomainUtilities
    {
        ...
        private static Version version10 = new Version("1.0");
        ...
        /// <summary>
        /// Set the target framework for app domain as nanoFrameowrk
        /// </summary>
        ...
        internal static void SetAppDomainFrameworkVersionBasedOnTestSource(
        ...
        internal static Version GetTargetFrameworkVersionFromVersionString(
            string version
            )
        {
            try
            {
                if (version.Length > TestAdapter.Constants.DotNetnanoFrameWorkStringPrefix.Length + 1)
                {
                    string versionPart = version.Substring(TestAdapter.Constants.DotNetnanoFrameWorkStringPrefix.Length + 1);
