...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter.Utilities
{
    ...
    internal class FileUtility
    {
        ...
        internal virtual void CreateDirectoryIfNotExists(
            string directory
            )
        {
        ...
        internal string ReplaceInvalidFileNameCharacters(
            string fileName
            )
        {
        ...
        internal virtual string CopyFileOverwrite(
            string source, 
            string destination, 
            out string warning
            )
        ...
        internal string FindAndDeployPdb(
            string destinationFile, 
            string relativeDestination,
            string sourceFile, 
            Dictionary<string, string> destToSource
            )
        {
        ...
        internal virtual List<string> AddFilesFromDirectory(
        ...
        internal string TryConvertPathToRelative(
            string path, 
            string rootDir
            )
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Requirement is to handle all kinds of user exceptions and message appropriately.")]
        internal virtual void DeleteDirectories(
            string filePath
            )
        {
        ...
        internal virtual bool DoesDirectoryExist(
        ...
        internal virtual bool DoesFileExist(
            string testSource
            )
        {
        ...
        internal virtual string[] GetFilesInADirectory(
            string directoryPath
            )
        {
        ...
        internal virtual string[] GetDirectoriesInADirectory(
            string directoryPath
            )
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Requirement is to handle all kinds of user exceptions and message appropriately.")]
        private string GetSymbolsFileName(
            string path
            )
        {
