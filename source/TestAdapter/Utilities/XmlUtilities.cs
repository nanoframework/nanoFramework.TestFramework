...
namespace nanoFramework.TestPlatform.MSTest.TestAdapter.Utilities
{
    ...
    internal class XmlUtilities
    {
        ...
        internal byte[] AddAssemblyRedirection(
            string configFile, 
        ...
        internal virtual XmlDocument GetXmlDocument(
            string configFile
            )
        {
        ...
        private static XmlElement FindOrCreateElement(
            XmlDocument doc, 
            XmlNode parent, 
            string name
            )
        ...
        private static XmlElement FindOrCreateAssemblyBindingSection(
            XmlDocument doc, 
